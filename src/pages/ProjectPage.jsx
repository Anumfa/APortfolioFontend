...
const project = resumeProjects[1];
  ...
  <div className="section page-top">
    <div className="container">
      ...
      <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="glass-panel">
        ...
        <h3 style={{ color: 'var(--text-light)', marginBottom: '0.75rem' }}>Outcome</h3>
        <p style={{ lineHeight: 1.8, fontSize: 'clamp(0.9rem, 2vw, 1rem)', color: 'var(--primary-color)' }}>{project.outcome}</p>
      </motion.div>
    </div>
  </div>
);
